  ...
  public static get() {
    return [
      ...
      [
        'v0.1.0',
        '2021/04/20',
        'API + Merged individual scores + Champion Recommendations',
        [
          ...
          'Merged individual scores into a single score, and added 3 in-depth individual scores:',
          'Solo - score for Summoner + Champion unrelated to this champion select',
      ...
      ['v0.1.1', '2021/04/27', 'Revert to v0.0.5', ['Reverted all changes to v0.0.5 because the prediction accuracy of v0.1.0 was lower due to a bug, as a temporary fix until the AI is fixed', 'Added Gwen champion sprites']],
      [
        'v0.1.2',
        '2021/05/18',
        'Fixed v0.1.0',
      ...
      ['v0.1.4', '2021/05/19', 'Better logging and hang prevention', ['Improved logging to facilitate debugging', 'Added timeout and retries to LoL client queries']],
      [
        'v0.1.5',
        '2021/05/23',
        'LCU failing fallback to API',
        [
      ...
      [
        'v0.1.10',
        '2021/06/11',
        'Improved the data fetching process',
        [
      ...
      [
        ...
        '2021/06/16',
        'Beta version',
        ['Allow changing to Beta version (Experimental features)', 'Allow manual version updates', 'Warn if not on latest version', 'Minor UI + logging improvements', "Minor bugfixes (tier wasn't showing on lane icon) "],
      ],
      ['v0.1.13', '2021/07/01', 'Exporting prediction logs', ['Added link to download prediction logs to a file', 'Bugfix KDA was flipped (assists and kills were swapped)', 'AI routine update']],
      ['v0.1.14', '2021/07/14', 'Mundo sprite update, bugfix', ['Fixed so it no longer crashes when tier data is corrupted, and instead ignores that tier', 'Updated Dr.Mundo sprite', 'AI routine update']],
      ...
      ['v0.2.5', '2021/09/20', 'AI on API v5', ['The AI now looks at all the fields from Riot API V5', 'Added Vex champion sprites ']],
      ...
      ['v0.2.8', '2022/01/23', 'Zeri update', ['Added Zeri sprite', 'AI update']],
      ['v0.2.9', '2022/02/06', 'AI update', ['Has now trained on Zeri matches', 'More continuous updates to follow early season meta']],
      [
        'v0.2.10',
        '2022/02/20',
        'Renata update',
        ['Added Renata sprites', 'AI update', 'Small bugfix where it would miss the smite spell on some matches and in normal games would have a harder time guessing the lane since it looked like nobody had smite '],
      ],
      ['v0.2.11', '2022/04/02', 'Routine update', ['Added Kassadin sprites', 'AI update']],
      ['v0.2.12', '2022/05/15', 'Routine update', ['AI adapted to the new observed behavior where ~8.0 was many times matched with ~8.0 in enemy team, so it was in fact a ~5.0 instead', 'AI update']],
      ['v0.2.13', '2022/06/12', "Bel'Veth", ["Bel'Veth sprites", 'AI update']],
      ...
      ['v0.3.4', '2023/02/13', '3rd AI Rework - Cleanup and stability', ['Multiple bugs fixed', 'Added tutorial', 'UX improvements', 'Improved error handling']],

      ['v0.3.5', '2023/02/13', 'French and bugfixes', ['French is now available as a language in settings - Big thanks to <b>Midnight</b> for his help with translation!', 'Bug fixes', 'Improved error handling']],

      ['v0.3.6', '2023/02/24', 'Migration of CSC servers', ['The database and CSC server was migrated']],

      ['v0.3.7', '2023/02/27', 'Champion Select optimistic AI bug fixed', ['The positive bias experienced during champion select was fixed', 'The AI now receives more information to make a more accurate prediction']],

      [
        'v0.3.8',
        '2023/03/19',
        'Subs and editable lobbies',
        [
      ...
      ['v0.3.26', '2025/01/19', 'Viktor and AI update', ['AI update', 'Viktor sprites']],
